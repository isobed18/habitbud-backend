...
# ============================================================================
# EMAIL (verification mails). Dev default prints to the console; set SMTP env
# vars in production (EMAIL_HOST etc.).
# ============================================================================
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'no-reply@habitbud.app')
